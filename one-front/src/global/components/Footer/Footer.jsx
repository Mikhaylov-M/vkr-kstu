        ...
        <nav className="footer__nav">
          ...
          <ul className="footer__list">
            <li className="footer__items">
              <NavHashLink to='/' smooth className="footer__links">
                Главная
              </NavHashLink>
            </li>
            <li className="footer__items">
              <NavHashLink to='/#calculator' smooth className="footer__links">
                Калькулятор
              </NavHashLink>
            </li>
            <li className="footer__items">
              <NavHashLink to='/#tracking' smooth className="footer__links">
                Отслеживание
              </NavHashLink>
            </li>
            <li className="footer__items">
              <NavHashLink to='/#contact' smooth className="footer__links">
                Контакты
              </NavHashLink>
            </li>
            <li className="footer__items">
          ...
          <div className="footer__social-wrapper">
            <a className="footer__social-links" href="https://t.me/oneexpresskg">
            ...
            <a className="footer__social-links" href="https://www.instagram.com/oneexpress.kg?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==">
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
